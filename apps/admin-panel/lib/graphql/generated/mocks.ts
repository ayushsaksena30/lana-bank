...
const generateMockValue = {
  ...
  telegramHandle: () => faker.string.alphanumeric(10),
...
export const mockAccountingTemplate = (overrides?: Partial<AccountingTemplate>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'AccountingTemplate' } & AccountingTemplate => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('AccountingTemplate');
    return {
        __typename: 'AccountingTemplate',
        chartRef: overrides && overrides.hasOwnProperty('chartRef') ? overrides.chartRef! : faker.lorem.word(),
        code: overrides && overrides.hasOwnProperty('code') ? overrides.code! : faker.lorem.word(),
        descriptionTemplate: overrides && overrides.hasOwnProperty('descriptionTemplate') ? overrides.descriptionTemplate! : faker.lorem.word(),
        entries: overrides && overrides.hasOwnProperty('entries') ? overrides.entries! : [relationshipsToOmit.has('AccountingTemplateEntry') ? {} as AccountingTemplateEntry : mockAccountingTemplateEntry({}, relationshipsToOmit)],
        id: overrides && overrides.hasOwnProperty('id') ? overrides.id! : generateMockValue.uuid(),
        name: overrides && overrides.hasOwnProperty('name') ? overrides.name! : generateMockValue.name(),
    };
};

export const mockAccountingTemplateCreateInput = (overrides?: Partial<AccountingTemplateCreateInput>, _relationshipsToOmit: Set<string> = new Set()): AccountingTemplateCreateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('AccountingTemplateCreateInput');
    return {
        chartRef: overrides && overrides.hasOwnProperty('chartRef') ? overrides.chartRef! : faker.lorem.word(),
        code: overrides && overrides.hasOwnProperty('code') ? overrides.code! : faker.lorem.word(),
        descriptionTemplate: overrides && overrides.hasOwnProperty('descriptionTemplate') ? overrides.descriptionTemplate! : faker.lorem.word(),
        entries: overrides && overrides.hasOwnProperty('entries') ? overrides.entries! : [relationshipsToOmit.has('AccountingTemplateEntryInput') ? {} as AccountingTemplateEntryInput : mockAccountingTemplateEntryInput({}, relationshipsToOmit)],
        name: overrides && overrides.hasOwnProperty('name') ? overrides.name! : generateMockValue.name(),
    };
};

export const mockAccountingTemplateCreatePayload = (overrides?: Partial<AccountingTemplateCreatePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'AccountingTemplateCreatePayload' } & AccountingTemplateCreatePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('AccountingTemplateCreatePayload');
    return {
        __typename: 'AccountingTemplateCreatePayload',
        accountingTemplate: overrides && overrides.hasOwnProperty('accountingTemplate') ? overrides.accountingTemplate! : relationshipsToOmit.has('AccountingTemplate') ? {} as AccountingTemplate : mockAccountingTemplate({}, relationshipsToOmit),
    };
};

export const mockAccountingTemplateEntry = (overrides?: Partial<AccountingTemplateEntry>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'AccountingTemplateEntry' } & AccountingTemplateEntry => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('AccountingTemplateEntry');
    return {
        __typename: 'AccountingTemplateEntry',
        accountIdOrCode: overrides && overrides.hasOwnProperty('accountIdOrCode') ? overrides.accountIdOrCode! : faker.lorem.word(),
        descriptionTemplate: overrides && overrides.hasOwnProperty('descriptionTemplate') ? overrides.descriptionTemplate! : faker.lorem.word(),
        direction: overrides && overrides.hasOwnProperty('direction') ? overrides.direction! : DebitOrCredit.Credit,
    };
};

export const mockAccountingTemplateEntryInput = (overrides?: Partial<AccountingTemplateEntryInput>, _relationshipsToOmit: Set<string> = new Set()): AccountingTemplateEntryInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('AccountingTemplateEntryInput');
    return {
        accountIdOrCode: overrides && overrides.hasOwnProperty('accountIdOrCode') ? overrides.accountIdOrCode! : faker.lorem.word(),
        descriptionTemplate: overrides && overrides.hasOwnProperty('descriptionTemplate') ? overrides.descriptionTemplate! : faker.lorem.word(),
        direction: overrides && overrides.hasOwnProperty('direction') ? overrides.direction! : DebitOrCredit.Credit,
...
export const mockAccountingTemplateUpdateInput = (overrides?: Partial<AccountingTemplateUpdateInput>, _relationshipsToOmit: Set<string> = new Set()): AccountingTemplateUpdateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('AccountingTemplateUpdateInput');
    return {
        chartRef: overrides && overrides.hasOwnProperty('chartRef') ? overrides.chartRef! : faker.lorem.word(),
        descriptionTemplate: overrides && overrides.hasOwnProperty('descriptionTemplate') ? overrides.descriptionTemplate! : faker.lorem.word(),
        entries: overrides && overrides.hasOwnProperty('entries') ? overrides.entries! : [relationshipsToOmit.has('AccountingTemplateEntryInput') ? {} as AccountingTemplateEntryInput : mockAccountingTemplateEntryInput({}, relationshipsToOmit)],
...
export const mockAccountingTemplateUpdatePayload = (overrides?: Partial<AccountingTemplateUpdatePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'AccountingTemplateUpdatePayload' } & AccountingTemplateUpdatePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('AccountingTemplateUpdatePayload');
    return {
...
export const mockCollateralUpdateInput = (overrides?: Partial<CollateralUpdateInput>, _relationshipsToOmit: Set<string> = new Set()): CollateralUpdateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CollateralUpdateInput');
    return {
...
export const mockCollateralUpdatePayload = (overrides?: Partial<CollateralUpdatePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CollateralUpdatePayload' } & CollateralUpdatePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CollateralUpdatePayload');
    return {
...
export const mockCreditFacilityLedgerAccounts = (overrides?: Partial<CreditFacilityLedgerAccounts>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CreditFacilityLedgerAccounts' } & CreditFacilityLedgerAccounts => {
    ...
    return {
        ...
        liquidatedCollateralAccount: overrides && overrides.hasOwnProperty('liquidatedCollateralAccount') ? overrides.liquidatedCollateralAccount! : relationshipsToOmit.has('LedgerAccount') ? {} as LedgerAccount : mockLedgerAccount({}, relationshipsToOmit),
        liquidatedCollateralAccountId: overrides && overrides.hasOwnProperty('liquidatedCollateralAccountId') ? overrides.liquidatedCollateralAccountId! : generateMockValue.uuid(),
...
export const mockCreditModuleConfig = (overrides?: Partial<CreditModuleConfig>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CreditModuleConfig' } & CreditModuleConfig => {
    ...
    return {
        ...
        chartOfAccountDisbursedDefaultedParentCode: overrides && overrides.hasOwnProperty('chartOfAccountDisbursedDefaultedParentCode') ? overrides.chartOfAccountDisbursedDefaultedParentCode! : faker.lorem.word(),
        ...
        chartOfAccountInterestDefaultedParentCode: overrides && overrides.hasOwnProperty('chartOfAccountInterestDefaultedParentCode') ? overrides.chartOfAccountInterestDefaultedParentCode! : faker.lorem.word(),
        ...
        chartOfAccountLiquidatedCollateralParentCode: overrides && overrides.hasOwnProperty('chartOfAccountLiquidatedCollateralParentCode') ? overrides.chartOfAccountLiquidatedCollateralParentCode! : faker.lorem.word(),
        ...
        chartOfAccountProceedsFromLiquidationParentCode: overrides && overrides.hasOwnProperty('chartOfAccountProceedsFromLiquidationParentCode') ? overrides.chartOfAccountProceedsFromLiquidationParentCode! : faker.lorem.word(),
...
export const mockCustomer = (overrides?: Partial<Customer>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Customer' } & Customer => {
    ...
    return {
        ...
        personalInfo: overrides && overrides.hasOwnProperty('personalInfo') ? overrides.personalInfo! : relationshipsToOmit.has('PersonalInfo') ? {} as PersonalInfo : mockPersonalInfo({}, relationshipsToOmit),
        publicId: overrides && overrides.hasOwnProperty('publicId') ? overrides.publicId! : faker.lorem.word(),
...
export const mockCustomerTelegramHandleUpdateInput = (overrides?: Partial<CustomerTelegramHandleUpdateInput>, _relationshipsToOmit: Set<string> = new Set()): CustomerTelegramHandleUpdateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CustomerTelegramHandleUpdateInput');
    return {
        customerId: overrides && overrides.hasOwnProperty('customerId') ? overrides.customerId! : generateMockValue.uuid(),
        telegramHandle: overrides && overrides.hasOwnProperty('telegramHandle') ? overrides.telegramHandle! : generateMockValue.telegramHandle(),
    };
...
export const mockCustomerTelegramHandleUpdatePayload = (overrides?: Partial<CustomerTelegramHandleUpdatePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'CustomerTelegramHandleUpdatePayload' } & CustomerTelegramHandleUpdatePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('CustomerTelegramHandleUpdatePayload');
    return {
...
export const mockDepositModuleConfig = (overrides?: Partial<DepositModuleConfig>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'DepositModuleConfig' } & DepositModuleConfig => {
    ...
    return {
        ...
        chartOfAccountFrozenNonDomiciledCompanyDepositAccountsParentCode: overrides && overrides.hasOwnProperty('chartOfAccountFrozenNonDomiciledCompanyDepositAccountsParentCode') ? overrides.chartOfAccountFrozenNonDomiciledCompanyDepositAccountsParentCode! : faker.lorem.word(),
...
export const mockDomainConfig = (overrides?: Partial<DomainConfig>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'DomainConfig' } & DomainConfig => {
    ...
    return {
        ...
        id: overrides && overrides.hasOwnProperty('id') ? overrides.id! : faker.string.uuid(),
        isSet: overrides && overrides.hasOwnProperty('isSet') ? overrides.isSet! : faker.datatype.boolean(),
...
export const mockMutation = (overrides?: Partial<Mutation>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Mutation' } & Mutation => {
    ...
    return {
        ...
        accountingTemplateCreate: overrides && overrides.hasOwnProperty('accountingTemplateCreate') ? overrides.accountingTemplateCreate! : relationshipsToOmit.has('AccountingTemplateCreatePayload') ? {} as AccountingTemplateCreatePayload : mockAccountingTemplateCreatePayload({}, relationshipsToOmit),
        accountingTemplateUpdate: overrides && overrides.hasOwnProperty('accountingTemplateUpdate') ? overrides.accountingTemplateUpdate! : relationshipsToOmit.has('AccountingTemplateUpdatePayload') ? {} as AccountingTemplateUpdatePayload : mockAccountingTemplateUpdatePayload({}, relationshipsToOmit),
        ...
        collateralUpdate: overrides && overrides.hasOwnProperty('collateralUpdate') ? overrides.collateralUpdate! : relationshipsToOmit.has('CollateralUpdatePayload') ? {} as CollateralUpdatePayload : mockCollateralUpdatePayload({}, relationshipsToOmit),
        ...
        customerTelegramHandleUpdate: overrides && overrides.hasOwnProperty('customerTelegramHandleUpdate') ? overrides.customerTelegramHandleUpdate! : relationshipsToOmit.has('CustomerTelegramHandleUpdatePayload') ? {} as CustomerTelegramHandleUpdatePayload : mockCustomerTelegramHandleUpdatePayload({}, relationshipsToOmit),
        ...
        prospectClose: overrides && overrides.hasOwnProperty('prospectClose') ? overrides.prospectClose! : relationshipsToOmit.has('ProspectClosePayload') ? {} as ProspectClosePayload : mockProspectClosePayload({}, relationshipsToOmit),
        prospectConvert: overrides && overrides.hasOwnProperty('prospectConvert') ? overrides.prospectConvert! : relationshipsToOmit.has('ProspectConvertPayload') ? {} as ProspectConvertPayload : mockProspectConvertPayload({}, relationshipsToOmit),
        prospectCreate: overrides && overrides.hasOwnProperty('prospectCreate') ? overrides.prospectCreate! : relationshipsToOmit.has('ProspectCreatePayload') ? {} as ProspectCreatePayload : mockProspectCreatePayload({}, relationshipsToOmit),
...
export const mockPersonalInfo = (overrides?: Partial<PersonalInfo>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'PersonalInfo' } & PersonalInfo => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('PersonalInfo');
    return {
        ...
        nationality: overrides && overrides.hasOwnProperty('nationality') ? overrides.nationality! : faker.lorem.word(),
    };
};
...
export const mockProspect = (overrides?: Partial<Prospect>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Prospect' } & Prospect => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('Prospect');
    return {
        __typename: 'Prospect',
        applicantId: overrides && overrides.hasOwnProperty('applicantId') ? overrides.applicantId! : generateMockValue.applicantId(),
        createdAt: overrides && overrides.hasOwnProperty('createdAt') ? overrides.createdAt! : generateMockValue.timestamp(),
        ...
        personalInfo: overrides && overrides.hasOwnProperty('personalInfo') ? overrides.personalInfo! : relationshipsToOmit.has('PersonalInfo') ? {} as PersonalInfo : mockPersonalInfo({}, relationshipsToOmit),
        prospectId: overrides && overrides.hasOwnProperty('prospectId') ? overrides.prospectId! : generateMockValue.uuid(),
        publicId: overrides && overrides.hasOwnProperty('publicId') ? overrides.publicId! : faker.lorem.word(),
        ...
        verificationLinkCreatedAt: overrides && overrides.hasOwnProperty('verificationLinkCreatedAt') ? overrides.verificationLinkCreatedAt! : generateMockValue.timestamp(),
    };
};

export const mockProspectCloseInput = (overrides?: Partial<ProspectCloseInput>, _relationshipsToOmit: Set<string> = new Set()): ProspectCloseInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ProspectCloseInput');
    return {
        prospectId: overrides && overrides.hasOwnProperty('prospectId') ? overrides.prospectId! : generateMockValue.uuid(),
    };
};

export const mockProspectClosePayload = (overrides?: Partial<ProspectClosePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'ProspectClosePayload' } & ProspectClosePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ProspectClosePayload');
    return {
        __typename: 'ProspectClosePayload',
        prospect: overrides && overrides.hasOwnProperty('prospect') ? overrides.prospect! : relationshipsToOmit.has('Prospect') ? {} as Prospect : mockProspect({}, relationshipsToOmit),
    };
};

export const mockProspectConnection = (overrides?: Partial<ProspectConnection>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'ProspectConnection' } & ProspectConnection => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ProspectConnection');
    return {
        __typename: 'ProspectConnection',
        edges: overrides && overrides.hasOwnProperty('edges') ? overrides.edges! : [relationshipsToOmit.has('ProspectEdge') ? {} as ProspectEdge : mockProspectEdge({}, relationshipsToOmit)],
        nodes: overrides && overrides.hasOwnProperty('nodes') ? overrides.nodes! : [relationshipsToOmit.has('Prospect') ? {} as Prospect : mockProspect({}, relationshipsToOmit)],
        pageInfo: overrides && overrides.hasOwnProperty('pageInfo') ? overrides.pageInfo! : relationshipsToOmit.has('PageInfo') ? {} as PageInfo : mockPageInfo({}, relationshipsToOmit),
    };
};

export const mockProspectConvertInput = (overrides?: Partial<ProspectConvertInput>, _relationshipsToOmit: Set<string> = new Set()): ProspectConvertInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ProspectConvertInput');
    return {
        prospectId: overrides && overrides.hasOwnProperty('prospectId') ? overrides.prospectId! : generateMockValue.uuid(),
    };
};

export const mockProspectConvertPayload = (overrides?: Partial<ProspectConvertPayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'ProspectConvertPayload' } & ProspectConvertPayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ProspectConvertPayload');
    return {
...
export const mockProspectCreateInput = (overrides?: Partial<ProspectCreateInput>, _relationshipsToOmit: Set<string> = new Set()): ProspectCreateInput => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ProspectCreateInput');
    return {
        customerType: overrides && overrides.hasOwnProperty('customerType') ? overrides.customerType! : CustomerType.Bank,
        email: overrides && overrides.hasOwnProperty('email') ? overrides.email! : generateMockValue.email(),
        telegramHandle: overrides && overrides.hasOwnProperty('telegramHandle') ? overrides.telegramHandle! : generateMockValue.telegramHandle(),
...
export const mockProspectCreatePayload = (overrides?: Partial<ProspectCreatePayload>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'ProspectCreatePayload' } & ProspectCreatePayload => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ProspectCreatePayload');
    return {
...
export const mockProspectEdge = (overrides?: Partial<ProspectEdge>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'ProspectEdge' } & ProspectEdge => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('ProspectEdge');
    return {
        __typename: 'ProspectEdge',
        cursor: overrides && overrides.hasOwnProperty('cursor') ? overrides.cursor! : generateMockValue.cursor(),
        node: overrides && overrides.hasOwnProperty('node') ? overrides.node! : relationshipsToOmit.has('Prospect') ? {} as Prospect : mockProspect({}, relationshipsToOmit),
    };
};
...
export const mockQuery = (overrides?: Partial<Query>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Query' } & Query => {
    ...
    return {
        ...
        accountingTemplate: overrides && overrides.hasOwnProperty('accountingTemplate') ? overrides.accountingTemplate! : relationshipsToOmit.has('AccountingTemplate') ? {} as AccountingTemplate : mockAccountingTemplate({}, relationshipsToOmit),
        accountingTemplates: overrides && overrides.hasOwnProperty('accountingTemplates') ? overrides.accountingTemplates! : [relationshipsToOmit.has('AccountingTemplate') ? {} as AccountingTemplate : mockAccountingTemplate({}, relationshipsToOmit)],
        approvalProcess: overrides && overrides.hasOwnProperty('approvalProcess') ? overrides.approvalProcess! : relationshipsToOmit.has('ApprovalProcess') ? {} as ApprovalProcess : mockApprovalProcess({}, relationshipsToOmit),
        ...
        prospect: overrides && overrides.hasOwnProperty('prospect') ? overrides.prospect! : relationshipsToOmit.has('Prospect') ? {} as Prospect : mockProspect({}, relationshipsToOmit),
        prospectByPublicId: overrides && overrides.hasOwnProperty('prospectByPublicId') ? overrides.prospectByPublicId! : relationshipsToOmit.has('Prospect') ? {} as Prospect : mockProspect({}, relationshipsToOmit),
        prospects: overrides && overrides.hasOwnProperty('prospects') ? overrides.prospects! : relationshipsToOmit.has('ProspectConnection') ? {} as ProspectConnection : mockProspectConnection({}, relationshipsToOmit),
